...
const songsList = [
  {
    name: "Wonderful Life",
    link: "audio/Black - Wonderful Life.mp3",
    artist: "Black",
    image: "img/black.jpg",
  },
  {
    name: "Holy Wars... The Punishment Due",
    link: "audio/01. Holy Wars... The Punishment Due.mp3",
    artist: "Megadeth",
    image: "img/Megadeth-RustInPeace.jpg",
  },
  {
    name: "Hangar 18",
    link: "audio/02. Hangar 18.mp3",
    artist: "Megadeth",
    image: "img/Megadeth-RustInPeace.jpg",
  },
  {
    name: "Take No Prisoners",
    link: "audio/03. Take No Prisoners.mp3",
    artist: "Megadeth",
    image: "img/Megadeth-RustInPeace.jpg",
  },
  {
    name: "Five Magics",
    link: "audio/04. Five Magics.mp3",
    artist: "Megadeth",
    image: "img/Megadeth-RustInPeace.jpg",
  },
  {
...
const initializePlaylist = () => {
  for (let i in songsList) {
    const playlistSong = document.createElement("li");
    playlistSong.classList.add("playlistSong");
    ...
    `;
    playlistSong.addEventListener("click", playlistSongHandler.bind(this, i));
    playlistSongs.append(playlistSong);
  }
};

function playlistSongHandler(i, e) {
  setSong(i);
  playAudio();
